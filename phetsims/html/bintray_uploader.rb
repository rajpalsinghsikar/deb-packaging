...
`curl -v -u#{$key} -H "X-Bintray-Debian-Distribution: trusty,xenial,jessie,stretch" -H "X-Bintray-Debian-Component: main" -H "X-Bintray-Debian-Architecture: all" -H "publish:1" -X PUT -T #{app}_1.0-1_all.deb https://api.bintray.com/content/balaswecha/balaswecha-dev/#{app}/1.0-1/pool/main/#{app}/#{app}/#{app}_1.0-1_all.deb`
